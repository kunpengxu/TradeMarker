...
export default function Settings() {
  ...
  const [githubRepo, setGithubRepo] = useState(() => getSettings().githubRepo || 'TradeMarker')
  ...
  return (
    <section><div className="page-head"><div><p className="eyebrow">Local data</p><h1>Settings</h1><p>Your TradeMarker data stays in this browser unless you export it.</p></div></div>
      ...
      <div className="settings-grid"><form className="panel api-key-panel" onSubmit={saveMarketData}><h2>Reference market data</h2><p>Yahoo Finance is the recommended default for this personal journal because it covers US and Canadian symbols and returns complete daily OHLCV without an API key.</p>
        ...
        <form className="panel api-key-panel" onSubmit={saveGitHubSettings}><h2>GitHub automatic backup</h2><p>Save your watchlist, groups, and journal to a JSON file in your repository and load newer data when the app opens.</p>
          ...
          <small>The token stays only in this browser. Give it access only to this repository with Contents: Read and write. Use a private repository if your journal data should remain private.</small><button type="submit">Save GitHub sync settings</button>
